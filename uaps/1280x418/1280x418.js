...
lib.ssMetadata = [
		{name:"1280x418_atlas_1", frames: [[1282,0,205,55],[1264,420,423,109],[0,420,1262,418],[0,0,1280,418]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,1262,418);
...
p.nominalBounds = new cjs.Rectangle(0,0,423,109);
...
p.nominalBounds = new cjs.Rectangle(0,0,205,55);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(394.5,462,1,1,0,0,0,102.5,27.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({_off:false},0).to({y:322.5},15,cjs.Ease.get(1)).wait(181));

	// Layer_3
	this.instance_1 = new lib.Symbol40("synched",0);
	this.instance_1.setTransform(253,116.5,1,1,0,0,0,211.5,54.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:268.5,alpha:1},29,cjs.Ease.get(1)).wait(211));
	...
	this.instance_3.setTransform(631,209,1,1,0,0,0,631,209);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:1.0571,scaleY:1.0571},239).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(604,197.1,694,292.4);
// library properties:
lib.properties = {
